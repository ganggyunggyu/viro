...
import { operationWorkerOnline } from '@/shared/lib/agent-management/operations';

export const runtime = 'nodejs';

export const GET = withManagementAuth(async ({ userId }) => NextResponse.json({
  version: '1',
  execution: { workerRequired: true, operationWorkerOnline: await operationWorkerOnline(userId) },
  capabilities: [
