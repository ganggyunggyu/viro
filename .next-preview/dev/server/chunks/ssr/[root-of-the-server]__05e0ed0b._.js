...
const writePostWithAccount = async (account, input)=>{
    ...
    try {
        ...
        if (images && images.length > 0) {
            ...
            const uploadSuccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$image$2d$uploader$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["uploadImages"])(page, images);
            if (uploadSuccess) {
            ...
            if (lastParagraphAfterImages) {
                await lastParagraphAfterImages.click({
                    timeout: 5000
                }).catch(()=>{});
                await page.keyboard.press('End');
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05e0ed0b._.js.map