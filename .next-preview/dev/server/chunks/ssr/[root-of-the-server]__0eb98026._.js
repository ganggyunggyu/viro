...
__turbopack_context__.s([
    ...
    "findCommentItemById",
    ()=>findCommentItemById,
    "getArticleWriterNickname",
    ()=>getArticleWriterNickname,
    "getClosestCommentItem",
    ()=>getClosestCommentItem,
...
const getArticleWriterNickname = async (root)=>{
...
const writeCommentWithAccount = async (account, cafeId, articleId, content, options)=>{
    ...
    try {
        ...
        if (writerNickname && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isNicknameEquivalent"])(writerNickname, commenterNickname)) {
            return {
                accountId: id,
                success: false,
...
"[project]/src/shared/lib/naver-cafe-writing/comment-deleter.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const listLiveComments = async (account, cafeId, articleId, options)=>{
    ...
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$multi$2d$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["touchAccount"])(id);
        const articleUrl = `https://cafe.naver.com/ca-fe/cafes/${cafeId}/articles/${articleId}`;
        const navResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["navigateToArticle"])(page, articleUrl, id, password, 'COMMENT-LIST', options);
        if (!navResult.success) {
            return {
                success: false,
                error: navResult.error
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$multi$2d$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["touchAccount"])(id);
        const root = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCommentRoot"])(page);
        const items = await root.$$('.CommentItem:not(.CommentItem--reply)');
        const comments = [];
        for (const item of items){
            const typedItem = item;
            const commentId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCommentIdFromItem"])(typedItem);
            if (!commentId) continue;
            const nickname = normalizeText(await typedItem.$eval('a[id^="cih"]', (el)=>el.textContent).catch(()=>''));
            const content = normalizeText(await typedItem.$eval('.comment_text_view', (el)=>el.textContent).catch(()=>''));
            comments.push({
                commentId,
                nickname,
                content
...
const deleteCommentWithAccount = async (account, cafeId, articleId, commentId, options)=>{
    const { id, password } = account;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$multi$2d$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["acquireAccountLock"])(id);
    try {
        const page = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$multi$2d$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPageForAccount"])(id);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$multi$2d$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["touchAccount"])(id);
        const articleUrl = `https://cafe.naver.com/ca-fe/cafes/${cafeId}/articles/${articleId}`;
        const navResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["navigateToArticle"])(page, articleUrl, id, password, 'COMMENT-DELETE', options);
        if (!navResult.success) {
            return {
                accountId: id,
                commentId,
        ...
        const root = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCommentRoot"])(page);
        const item = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findCommentItemById"])(root, commentId);
        if (!item) {
            return {
                accountId: id,
                commentId,
                success: false,
                error: '댓글을 찾을 수 없음 (이미 삭제됐거나 렌더링 안됨)'
            };
        }
        ...
        if (!optionBtn) {
            return {
                ...
                commentId,
                success: false,
                error: '더보기 버튼 없음 (본인 댓글이 아니거나 이미 삭제됨)'
            };
        }
        ...
        await page.waitForTimeout(1500);
        const errorMessage = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkErrorPopup"])(page);
        if (errorMessage) {
            return {
                accountId: id,
                commentId,
        ...
        const stillThere = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$writer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["findCommentItemById"])(root, commentId);
        if (stillThere) {
            return {
                accountId: id,
                commentId,
                success: false,
                error: '삭제 클릭 후에도 댓글이 여전히 존재함'
            };
        }
        return {
            accountId: id,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$naver$2d$cafe$2d$writing$2f$comment$2d$deleter$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/lib/naver-cafe-writing/comment-deleter.ts [app-rsc] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0eb98026._.js.map