...
"[project]/src/shared/lib/fetch-topic-image.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "fetchTopicImageAsBase64",
    ()=>fetchTopicImageAsBase64
]);
const IMAGE_GEN_URL = process.env.IMAGE_GEN_URL || 'http://localhost:3939';
const fetchTopicImageAsBase64 = async (keyword)=>{
    try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$fetch$2d$topic$2d$image$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/lib/fetch-topic-image.ts [app-rsc] (ecmascript)");
...
const addBatchToQueue = async (input)=>{
    ...
    for(let i = 0; i < keywords.length; i++){
        ...
        try {
            ...
            const image = attachImages ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$fetch$2d$topic$2d$image$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchTopicImageAsBase64"])(keyword) : null;
            if (attachImages) {
...
//# sourceMappingURL=src_a8d1b83d._.js.map