...
const COMMENT_CLUSTERS: CommentCluster[] = [
  {
    name: "질문/실전확인",
    instruction: `본댓글 [댓글1]~[댓글3]만 작성한다.
- 숫자, 기간, 병원 일정, 수치, 검사, 약 복용 질문 중심.
- "저", "저도", "저는", "저랑"으로 시작 금지.
- 시작 예시 리듬: "56일이면", "내막 5mm", "프로게스테론".
- 각 댓글은 1~3문장.`,
  },
  {
    name: "개인사연",
    instruction: `본댓글 [댓글4]~[댓글6]만 작성한다.
- 서로 다른 사람 3명의 개인 사연.
- 긴 댓글 2개, 중간 댓글 1개.
...
- 말투는 담담한 사람, 급한 사람, 울컥한 사람, 정보형 사람을 섞는다.`,
  ...
  {
    name: "짧은반응/생활장면",
    instruction: `본댓글 [댓글7]~[댓글8]만 작성한다.
- 짧은 반응 1개, 생활 장면 1개.
...
- [작성자-1], [작성자-2], [댓글러-2], [작성자-3], [제3자-3], [작성자-4], [댓글러-4], [작성자-5], [제3자-6], [작성자-7], [댓글러-8] 형식으로 작성한다.
...
출력 형식:
[댓글]
(14~20개, 본댓글 6~8개 + 대댓글 8~12개. 각 줄은 [댓글N]/[작성자-N]/[댓글러-N]/[제3자-N] 태그로 시작)
